...
public class UserInterface {
    ...
    public void addFlight() {
        ...
        FlightPath flightpath = new FlightPath(currentAirport.getSpecificAirplane(ID),depAirCode,destAirCode);
    ...
    public void printPlanes() {
        System.out.println(this.currentAirport.printAirplanes());
    } 
    ...
    public void printPlaneInfo() {
        System.out.print("Give plane ID: ");
        String input = this.reader.nextLine();        
        System.out.println(this.currentAirport.getSpecificAirplane(input));
    }
}